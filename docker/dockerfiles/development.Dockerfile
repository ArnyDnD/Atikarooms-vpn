## TFLINT
FROM registry.gitlab.com/gitlab-org/terraform-images/releases/1.3:latest as tflint-builder
...
## DEV
FROM registry.gitlab.com/gitlab-org/terraform-images/releases/1.3:latest
